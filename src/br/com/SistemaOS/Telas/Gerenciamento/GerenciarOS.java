...
public class GerenciarOS extends JFrame {
    ...
    private void inicializarLabels() {
        painelPrincipal.add(screenTools.criarLabel("Ordens de Serviço", (this.getWidth() - 200) / 2, 11, 200, 47, 30, true));
    }
    ...
    private void inicializarListeners() {
        botaoCriarOS.addActionListener(e -> {
            JOptionPane.showMessageDialog(null, "Funcionalidade para criar nova OS ainda não implementada.");
        });
    ...
    private void atualizarTabela(List<OrdemServico> ordensServico) {
        String[] colunas = {"ID OS", "Equipamento", "Defeito", "Técnico", "Valor", "Cliente ID"};
    ...
    public static void main(String[] args) {
        ...
        GerenciarOS telaOS = new GerenciarOS(user);

...
public class GerenciarClientes extends JFrame {
    ...
    // Utilitários
    private UtilitariosTela utilitariosTela = new UtilitariosTela();
    ...
    public GerenciarClientes() {
        ...
        painelPrincipal.setBackground(utilitariosTela.getBackgroundColor());
    ...
    private void filtrarClientes(String textoPesquisa) {
        if (listaTodosClientes.equals("Digite o nome do cliente...") || textoPesquisa.trim().isEmpty()) carregarClientes();

...
public class DetalhesUsuario extends JFrame {
	...
	private void initComponents(Integer id, String nome, String fone, String login, String senha, String perfil, Usuario usu) {
	...
	private void getUserData(Integer id, String nome, String fone, String login, String senha, String perfil, Usuario usu) {
		this.user = usu;
		this.idUser = id;
    	this.nomeUser = nome;
    	this.foneUser = fone;
    	...
    	this.dao = new CentroUsuariosDAO();
	...
	private void initLabels() {
    	contentPane.add(util.criarLabel("Informação do Usuário", 315, 0, 521, 52, 35));
	        ...
	        if (nomeUser.equalsIgnoreCase("administrador")) { 
	            if (user.getNome().equalsIgnoreCase("administrador")) {
	                ...
	                JOptionPane.showMessageDialog(
	                    null, 
	                    "Apenas o administrador pode alterar suas informações", 
	                    "Erro", 
    ...
    private void deletarUsuario() {
    	if(idUser.equals(1)) {
    		JOptionPane.showMessageDialog(null,"Você não pode deletar este Usuário Por questão de segurança!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
    		return;
    	}
     ...
     // Verificar perfil
        ...
        if (camposVazios.length() > 0) {
            ...
            if (update.stream().allMatch(Objects::isNull)) {
            	...
            	if (update.get(0) != null) nomeUser = update.get(0).toString();
            	if (update.get(1) != null) foneUser = update.get(1).toString();
            	if (update.get(2) != null) loginUser = update.get(2).toString();
            	if (update.get(3) != null) senhaUser = update.get(3).toString();
            	if (update.get(4) != null) perfilUser = update.get(4).toString();

...
import javax.swing.SwingConstants;
	...
	public class DetalhesOS extends JFrame {
	    ...
	    public DetalhesOS() {
	        ...
	        btnOk.addActionListener(e -> this.dispose());  // Close the window on click
	    ...
	    private void addFieldAndLabel(String labelText, int labelX, int labelY, JTextField field) {
	        ...
	        field.setEditable(false);  // Impede edição
	        field.setBackground(new Color(240, 240, 240));  // Torna o fundo do campo mais claro para indicar que não é editável
	        field.setFocusable(false);  // Remove o indicador de escrita (cursor)
